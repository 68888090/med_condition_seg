...
model = SSLHead(args)
model.cuda()
model_dict = torch.load("/home/lhr/dataset/checkpoints/swin-unetr/model_swinvit_fixed.pt")
model.load_state_dict(model_dict["state_dict"])
# content = torch.load("/home/lhr/dataset/checkpoints/swin-unetr/model_swinvit.pt")
