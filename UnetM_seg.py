...
class UnetM(nn.Module):
    ...
    def forward(self,  img2):
        ...
        with torch.no_grad():
            combined_out, enc0 = self.feature_extractor(img2)
        ...
        # Up 1
        cat3 = fused_skips[3]
        dec3 = self.decoder5(fused_skips[4], cat3)
        ...
        # Final Up
        dec0 = self.decoder1(dec0,enc0)
        dec0 = self.dropout(dec0) # <--- Dropout
        
        # Head
        aux_logits = self.nodule_detection_head(dec0) 
